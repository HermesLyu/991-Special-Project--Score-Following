...
t = 0;
tim = timer('ExecutionMode','fixedRate','BusyMode','drop','Period',1, 'TimerFcn', 'showscore(t, tmid, step, seg, speed, midlength); tmid = tmid + step*speed(seg); t = t + step; seg=seg+1')
